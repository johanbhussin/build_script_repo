...
do
 ...
 mkdir /build/linux_build/cv/"$i"

 mv vmlinux /build/linux_build/cv/"$i"
 mv arch/arm/boot/zImage /build/linux_build/cv/"$i"
 mv arch/arm/boot/dts/socfpga_cyclone5_socdk.dtb /build/linux_build/cv/"$i"
