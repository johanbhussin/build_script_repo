...
mkdir -p /build/linux_regtest/arm/$LINUX_VER/a10

cp arch/arm/boot/zImage /build/linux_regtest/arm/$LINUX_VER/a10
cp arch/arm/boot/dts/socfpga_arria10_socdk_qspi.dtb /build/linux_regtest/arm/$LINUX_VER/a10
cp arch/arm/boot/dts/socfpga_arria10_socdk_sdmmc.dtb /build/linux_regtest/arm/$LINUX_VER/a10
cp drivers/mtd/tests/mtd_readtest.ko /build/linux_regtest/arm/$LINUX_VER/a10
cp drivers/mtd/tests/mtd_stresstest.ko /build/linux_regtest/arm/$LINUX_VER/a10
cp drivers/mtd/tests/mtd_speedtest.ko /build/linux_regtest/arm/$LINUX_VER/a10
