...
mkdir -p /build/linux_regtest/arm/$LINUX_VER/cv

cp arch/arm/boot/zImage /build/linux_regtest/arm/$LINUX_VER/cv
cp arch/arm/boot/dts/socfpga_cyclone5_socdk.dtb /build/linux_regtest/arm/$LINUX_VER/cv
cp drivers/mtd/tests/mtd_readtest.ko /build/linux_regtest/arm/$LINUX_VER/cv
cp drivers/mtd/tests/mtd_stresstest.ko /build/linux_regtest/arm/$LINUX_VER/cv
cp drivers/mtd/tests/mtd_speedtest.ko /build/linux_regtest/arm/$LINUX_VER/cv
